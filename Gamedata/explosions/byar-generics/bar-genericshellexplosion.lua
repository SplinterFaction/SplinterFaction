local root = "bar-genericshellexplosion"
local definitions = {
  [root.."-tiny"] = {
    --groundflash = {
    --  air                = true,
...
definitions['bar-genericshellexplosion-medium-aoe'] = table.copy(definitions[root.."-medium"])
definitions['bar-genericshellexplosion-medium-aoe'].dustparticles.properties.numparticles = 10
definitions['bar-genericshellexplosion-medium-aoe'].shockwave.count = 1
definitions['bar-genericshellexplosion-medium-aoe'].dirtrush.count = 1
definitions['bar-genericshellexplosion-medium-aoe'].bigsmoketrails.count = 4
definitions['bar-genericshellexplosion-medium-aoe'].bigsmoketrails.properties.ttl = [[28 r3]]
definitions['bar-genericshellexplosion-medium-aoe'].bigsmoketrails.properties.length = [[28 r5]]
definitions['bar-genericshellexplosion-medium-aoe'].explosion.properties.colormap = [[0 0 0 0   1 0.62 0.38 0.09   0.7 0.27 0.1 0.066   0.5 0.15 0.025 0.033   0 0 0 0]]
definitions['bar-genericshellexplosion-medium-aoe'].explosion2.properties.colormap = [[0 0 0 0   1 0.32 0.18 0.09   0.7 0.17 0.05 0.066   0.3 0.08 0.015 0.033   0 0 0 0]]

definitions['bar-genericshellexplosion-small-t2'] = table.copy(definitions[root.."-small"])
definitions['bar-genericshellexplosion-small-t2'].explosion.properties.particlesize = 8

definitions['antinukeexplosion'] = table.copy(definitions[root.."-large"])

definitions['bar-genericshellexplosion-debris'] = table.copy(definitions[root.."-tiny"])
definitions['bar-genericshellexplosion-debris'].explosion.properties.colormap = [[0 0 0 0   1 0.77 0.44 0.06   0.75 0.38 0.14 0.045   0.55 0.22 0.04 0.02   0 0 0 0]]
definitions['bar-genericshellexplosion-debris'].explosion.properties.numparticles = 3
definitions['bar-genericshellexplosion-debris'].explosion.properties.particlesize = 0.44
definitions['bar-genericshellexplosion-debris'].explosion.properties.particlesizespread = 0.6
definitions['bar-genericshellexplosion-debris'].explosion.properties.particlespeed = 0.35
definitions['bar-genericshellexplosion-debris'].explosion.properties.particlespeedspread = 1.1
definitions['bar-genericshellexplosion-debris'].innersmoke.properties.particleLife = 7
definitions['bar-genericshellexplosion-debris'].innersmoke.properties.particleLifeSpread = 10
definitions['bar-genericshellexplosion-debris'].innersmoke.properties.particlesize = 4
definitions['bar-genericshellexplosion-debris'].innersmoke.properties.particlesizespread = 2.2
definitions['bar-genericshellexplosion-debris'].innersmoke.properties.particlespeedspread = 1.2
definitions['bar-genericshellexplosion-debris'].groundflash_small.properties.colormap = [[1 0.6 0.25 0.2   0 0 0 0.01]]
definitions['bar-genericshellexplosion-debris'].groundflash_small.properties.size = 13
definitions['bar-genericshellexplosion-debris'].groundflash_small.properties.ttl = 9
definitions['bar-genericshellexplosion-debris'].explosion2 = nil
definitions['bar-genericshellexplosion-debris'].outersmoke = nil
definitions['bar-genericshellexplosion-debris'].sparks = nil
definitions['bar-genericshellexplosion-debris'].groundflash_large = nil
definitions['bar-genericshellexplosion-debris'].centerflare = nil
definitions['bar-genericshellexplosion-debris'].dustparticles = nil
definitions['bar-genericshellexplosion-debris'].dirt = nil
definitions['bar-genericshellexplosion-debris'].dirt2 = nil
definitions['bar-genericshellexplosion-debris'].shard1 = nil
definitions['bar-genericshellexplosion-debris'].shard2 = nil
definitions['bar-genericshellexplosion-debris'].shard3 = nil
definitions['bar-genericshellexplosion-debris'].clouddust = nil
definitions['bar-genericshellexplosion-debris'].outerflash = nil

definitions['bar-genericshellexplosion-debris2'] = table.copy(definitions[root.."-debris"])
definitions['bar-genericshellexplosion-debris2'].explosion.properties.numparticles = 2
definitions['bar-genericshellexplosion-debris2'].explosion.properties.particlesize = 0.35
definitions['bar-genericshellexplosion-debris2'].explosion.properties.particlesizespread = 0.45
definitions['bar-genericshellexplosion-debris2'].explosion.properties.particlespeed = 0.25
definitions['bar-genericshellexplosion-debris2'].explosion.properties.particlespeedspread = 0.66
definitions['bar-genericshellexplosion-debris2'].explosion2 = nil

definitions['bar-genericshellexplosion-catapult'] = table.copy(definitions[root.."-large-bomb"])
definitions['bar-genericshellexplosion-catapult'].explosion.properties.numparticles = 4
definitions['bar-genericshellexplosion-catapult'].explosion.properties.colormap = [[0 0 0 0   1 0.45 0.25 0.09   0.75 0.35 0.15 0.066   0.44 0.25 0.06 0.033   0 0 0 0]]
definitions['bar-genericshellexplosion-catapult'].explosion2.properties.numparticles = 4
definitions['bar-genericshellexplosion-catapult'].explosion2.properties.colormap = [[0 0 0 0   1 0.38 0.1 0.09   0.55 0.22 0.05 0.066   0.25 0.08 0.03 0.033   0 0 0 0]]
definitions['bar-genericshellexplosion-catapult'].dustparticles.properties.numparticles = 1
definitions['bar-genericshellexplosion-catapult'].dirt.properties.numparticles = 3
definitions['bar-genericshellexplosion-catapult'].dirt2.properties.numparticles = 3
definitions['bar-genericshellexplosion-catapult'].sparks.properties.numparticles = 4
definitions['bar-genericshellexplosion-catapult'].clouddust.properties.numparticles = 1


definitions['bar-genericshellexplosion-sniper'] = table.copy(definitions[root.."-large"])
definitions['bar-genericshellexplosion-sniper'].explosion.properties.colormap    = [[0 0 0 0   1 0.3 0.15 0.01   1 0.2 0.12 0.01   0.8 0.16 0.09 0.01   0 0 0 0]]
definitions['bar-genericshellexplosion-sniper'].explosion.properties.numparticles = definitions['bar-genericshellexplosion-sniper'].explosion.properties.numparticles*1.3
definitions['bar-genericshellexplosion-sniper'].explosion2.properties.colormap    = [[0 0 0 0   1 0 0 0.01   1 0.1 0.09 0.01   0.8 0.1 0.05 0.01   0 0 0 0]]
definitions['bar-genericshellexplosion-sniper'].explosion2.properties.numparticles = definitions['bar-genericshellexplosion-sniper'].explosion2.properties.numparticles*1.3
definitions['bar-genericshellexplosion-sniper'].sparks.properties.colormap        = [[1 0.3 0.1 0.01   0.9 0.3 0.2 0.017   0 0 0 0]]
definitions['bar-genericshellexplosion-sniper'].explosion.properties.particlesize = definitions['bar-genericshellexplosion-sniper'].explosion.properties.particlesize * 0.85
definitions['bar-genericshellexplosion-sniper'].explosion.properties.particlesizespread = definitions['bar-genericshellexplosion-sniper'].explosion.properties.particlesizespread * 0.85
definitions['bar-genericshellexplosion-sniper'].explosion2.properties.particlesize = definitions['bar-genericshellexplosion-sniper'].explosion2.properties.particlesize * 0.85
definitions['bar-genericshellexplosion-sniper'].explosion2.properties.particlesizespread = definitions['bar-genericshellexplosion-sniper'].explosion2.properties.particlesizespread * 0.85
