  ...
  ["burnblack"] = {
    kickedupdirt = {
      ...
      properties = {
        airdrag            = 0.87,
        alwaysvisible      = false,
        colormap           = [[1 1 1 1    1 1 1 1   1 0.5 0.0 0.5   0 0 0 0.5    0 0 0 0.3    0 0 0 0.2   0 0 0 0.01]],
        directional        = false,
        emitrot            = 90,
        emitrotspread      = 5,
        emitvector         = [[0, 1, 0]],
        ...
        animParams          = [[8,6,25]], --[xTiles, yTiles, animLength in game frames]
        texture            = [[generated-burn]],
      },
    },
  },
  ...
  ["burnblacksmall"] = {
    kickedupdirt = {
      ...
      properties = {
        ...
        sizemod            = 0.9,
        rotParams           = [[-24 r48, -60 r120, -180 r360]],
        animParams          = [[8,6,10]], --[xTiles, yTiles, animLength in game frames]
        texture            = [[generated-burn]],
      },
    },
  },
