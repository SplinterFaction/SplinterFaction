  ...
  ["burnblack"] = {
    fire = {
      ...
      properties = {
        airdrag            = 0.7,
        --alwaysvisible      = true,
        colormap           = [[1 1 1 0.8    1 1 1 0.8   1 1 1 0.8    0 0 0 0]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 1, 0]],
        ...
        sizemod            = 1,
        rotParams           = [[0, 0, 0]],
        animParams          = [[4,4,4]], --[xTiles, yTiles, animLength in game frames]
        pos                 = [[0,4,0]],
        texture            = [[generated-firerising]],
        useairlos          = false,
      },
    },
    ...
    smoke = {
      ...
      properties = {
        airdrag            = 0.7,
        --alwaysvisible      = true,
        colormap           = [[0.2 0.2 0.2 0.8    0.2 0.2 0.2 0.8   0.2 0.2 0.2 0.8    0 0 0 0]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 1, 0]],
  ...
  ["burnblacksmall"] = {
    fire = {
      ...
      properties = {
        airdrag            = 0.7,
        --alwaysvisible      = true,
        colormap           = [[1 0.8 0.8 0.8    1 0.8 0.8 0.8   1 0.8 0.8 0.8    0 0 0 0]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 1, 0]],
  ...
  ["burnblackboomerang"] = {
    fire = {
      ...
      properties = {
        airdrag            = 0.7,
        --alwaysvisible      = true,
        --colormap           = [[1 0.8 0.8 0.8    1 0.8 0.8 0.8   1 0.8 0.8 0.8   0 0 0 0.25        0 0 0 0]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 0,
        emitvector         = [[0, 1, 0]],
