...
local unitName                    = "largeshieldgenerator"
...
local unitDef                     = {
	...
	onOffable					  = true,
	objectName                    = "largeshieldgenerator.s3o",
	script			              = "largeshieldgenerator_lus.lua",
	repairable		              = false,
...
local weaponDefs                  = {
	shield                        = {
		...
		ShieldStartingPower       = shield1Power,
		Shieldenergyuse           = 0,
		Shieldradius              = 750,
