...
local Base = {
	...
	customparams = { -- this will be customParams (note capital P) ingame
		author = "Beherith", -- models: Blender Market "30 Stylized Rock Asset Pack" (see Objects3D/rocks30/licence.txt)
		category = "rocks",
		set = "rocks30",
		normalmaps = "yes",
...
-- "map" biome models reference rocks30_map_color.dds / _other.dds which are NOT shipped here:
-- a map that places rocks30_map_* is expected to provide those textures in its own archive.
