...
local Base = {
	...
	customparams = { -- this will be customParams (note capital P) ingame
		author = "Beherith", -- used in SplinterFaction with permission; not for redistribution to other games
		light = "crystal", -- picked up by DeferredLightsGL4config.lua featureGlowPatterns
		category = "crystals",
		set = "Crystals",
		normalmaps = "yes",
