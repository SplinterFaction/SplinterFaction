...
function script.AimWeapon(WeaponID, heading, pitch)
    ...
    if WeaponID == 1 then
        ...
        Turn(gatlingturret1, y_axis, heading, 2)
    ...
    elseif WeaponID == 4 then
        ...
        Turn(rocketturret1, y_axis, heading, 2)
        Turn(rocketbarrel1, x_axis, -pitch, 2)
    ...
    elseif WeaponID == 5 then
        ...
        Turn(rocketturret2, y_axis, heading, 2)
        Turn(rocketbarrel2, x_axis, -pitch, 2)
