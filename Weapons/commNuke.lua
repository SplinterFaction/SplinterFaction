commNukes = {
	...
	commnuke                   = {
		...
		customparams              = {
			...
			expl_light_radius	= 5000, -- In Elmos
	...
	commnuke_up2                   = {
		...
		customparams              = {
			...
			friendlyfireexception = true,
			expl_light_color	= orange, -- As a string, RGB
			expl_light_radius	= 20000, -- In Elmos
			expl_light_life		= 700, -- In frames I.E. 30 frames = 1 second
			expl_light_opacity  = 0.25, -- Use this sparingly
		},
		damage                    = {
			default               = 2000,
	...
	commnuke_up3                   = {
		...
		customparams              = {
			...
			friendlyfireexception = true,
			expl_light_color	= orange, -- As a string, RGB
			expl_light_radius	= 30000, -- In Elmos
			expl_light_life		= 800, -- In frames I.E. 30 frames = 1 second
			expl_light_opacity  = 0.25, -- Use this sparingly
		},
		damage                    = {
			default               = 10000,
	...
	commnuke_up4                   = {
		...
		customparams              = {
			...
			friendlyfireexception = true,
			expl_light_color	= orange, -- As a string, RGB
			expl_light_radius	= 50000, -- In Elmos
