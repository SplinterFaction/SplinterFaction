unitDef                    = {
	...
	customParams                 = {
		...
		nofriendlyfire	         = "1",
		supply_cost              = 1,
		trail_pieces             = "wingtiplf,wingtiprf,canardlf:0.5,canardrf:0.5,canardlr:0.5,canardrr:0.5",
		trail_width              = "7",  -- optional
