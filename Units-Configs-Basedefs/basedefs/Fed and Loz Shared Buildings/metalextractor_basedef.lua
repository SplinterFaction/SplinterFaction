unitDef                     = {
	...
	energyStorage                 = 100,
	energyUse                     = 0.1, -- This value is controlled by game_metal_maker_output_scaler.lua
	...
	maxWaterDepth                 = 5000,
	metalStorage                  = 100,
	makesmetal                    = 0.1, -- This value is controlled by game_metal_maker_output_scaler.lua
	name                          = humanName,
