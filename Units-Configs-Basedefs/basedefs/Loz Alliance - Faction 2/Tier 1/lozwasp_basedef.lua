...
-- Flight Characteristics Settings
	...
	maxVelocity        = 11.25,   -- Your defined top speed
	...
	customParams                 = {
		...
		nofriendlyfire	         = "1",
		supply_cost              = 1,
		trail_pieces             = "wingtipl,wingtipr,canardlf:0.5,canardrf:0.5",
...
weaponDefs                 = {
	laser                = {
		...
		rgbColor               = "1 0 0",
		rgbColor2              = "1 1 1",
		explosionGenerator     = "custom:genericshellexplosion-small-orange",
		edgeEffectiveness	   = 1,
		energypershot          = 0,
		fallOffRate            = 0,
		duration			   = 0.1,
