pelvis, dirt, lthigh, rthigh, lleg, rleg, lfoot, rfoot, turret, gatlingbarrel, gatlingfirepoint1, cannonbarrel, cannonfirepoint1 = piece('pelvis', 'dirt', 'lthigh', 'rthigh', 'lleg', 'rleg', 'lfoot', 'rfoot', 'turret', 'gatlingbarrel', 'gatlingfirepoint1', 'cannonbarrel', 'cannonfirepoint1')
local SIG_AIM = {}
local SIG_AIM2 = {}
...
local function RestoreAfterDelay()
    ...
    Turn(gatlingbarrel, x_axis, 0, 5)
    Turn(cannonbarrel, x_axis, 0, 5)
end
...
function script.AimWeapon(WeaponID, heading, pitch)
    if WeaponID == 1 then
        ...
        Turn(gatlingbarrel, x_axis, -pitch, 100)
...
local function Walk()
    ...
    while true do
        ...
        Turn(turret, x_axis, -0.103721, 3.111627 * speedMult) -- delta=5.94
        ...
        Turn(turret, x_axis, -0.275261, 5.146208 * speedMult) -- delta=9.83
        ...
        Turn(turret, x_axis, -0.103721, 5.146208 * speedMult) -- delta=-9.83
        ...
        Turn(turret, x_axis, 0.000000, 3.111627 * speedMult) -- delta=-5.94
        ...
        Turn(turret, x_axis, -0.081531, 2.445934 * speedMult) -- delta=4.67
        Move(pelvis, y_axis, -0.450000, 13.500000 * speedMult) -- delta=-0.45
        Turn(pelvis, x_axis, 0.043633, 1.308997 * speedMult) -- delta=-2.50
        ...
        Turn(turret, x_axis, -0.231348, 4.494519 * speedMult) -- delta=8.58
        Move(pelvis, y_axis, -1.180000, 21.899999 * speedMult) -- delta=-0.73
        Turn(pelvis, x_axis, 0.087266, 1.308997 * speedMult) -- delta=-2.50
        Turn(pelvis, y_axis, -0.130900, 3.926991 * speedMult) -- delta=-7.50
        ...
        Turn(turret, x_axis, -0.081531, 4.494519 * speedMult) -- delta=-8.58
        Move(pelvis, y_axis, -0.450000, 21.899999 * speedMult) -- delta=0.73
        Turn(pelvis, x_axis, 0.043633, 1.308997 * speedMult) -- delta=2.50
        Turn(pelvis, y_axis, -0.000000, 3.926991 * speedMult) -- delta=7.50
        ...
        Turn(turret, x_axis, 0.000000, 2.445934 * speedMult) -- delta=-4.67
        Move(pelvis, y_axis, 0.000000, 13.500000 * speedMult) -- delta=0.45
        Turn(pelvis, x_axis, -0.000000, 1.308997 * speedMult) -- delta=2.50
...
local function StopWalking()
    ...
    Turn(turret, x_axis, 0.000000, 12.865521 * speedMult)
