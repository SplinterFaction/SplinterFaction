...
local deathPieces = {
	pelvis, turret, barrel1, firepoint1, firepoint2, firepoint3, firepoint4, dirt, lthigh, rthigh, lleg, rleg, lfoot, rfoot,
}
...
function script.Create()
	StartThread(common.SmokeUnit, {pelvis, turret, barrel1, firepoint1, firepoint2, firepoint3, firepoint4, lthigh, rthigh, lleg, rleg, lfoot, rfoot})
end
