...
local deathPieces = {
	base, rearwheels, frontwheels, dirt, turret, barrel1, firepoint1,
}
local SIG_AIM = {}
...
function script.Create()
    StartThread(common.SmokeUnit, {base, rearwheels, frontwheels, turret, barrel1, firepoint1})
    building = false
end
...
local function RestoreAfterDelay()
    Sleep(2000)
    Turn(turret, y_axis, 0, 50)
    Turn(barrel1, x_axis, 0, 50)
end
...
function script.AimWeapon(weaponID, heading, pitch)
    ...
    Turn(turret, y_axis, heading, 500)
    Turn(barrel1, x_axis, -pitch, 500)
