...
base, pivotpoint, armleft, armright, armrear, armfront, sfxpoint1, bottom1, topspin1, sfxpointt1, bottom2, topspin2, sfxpointt2, laserturret1, laserbarrel1, laserfirepoint11, laserfirepoint12, laserturret2, laserbarrel2, laserfirepoint21, laserfirepoint22 = piece('base', 'pivotpoint', 'armleft', 'armright', 'armrear', 'armfront', 'sfxpoint1', 'bottom1', 'topspin1', 'sfxpointt1', 'bottom2', 'topspin2', 'sfxpointt2', 'laserturret1', 'laserbarrel1', 'laserfirepoint11', 'laserfirepoint12', 'laserturret2', 'laserbarrel2', 'laserfirepoint21', 'laserfirepoint22')

local deathPieces = {
	base, pivotpoint, armleft, armright, armrear, armfront, sfxpoint1, bottom1, topspin1, sfxpointt1, bottom2, topspin2, sfxpointt2, laserturret1, laserbarrel1, laserfirepoint11, laserfirepoint12, laserturret2, laserbarrel2, laserfirepoint21, laserfirepoint22,
}
...
function script.Create()
	StartThread(common.SmokeUnit, {base, pivotpoint, armleft, armright, armrear, armfront, sfxpoint1, bottom1, topspin1, sfxpointt1, bottom2, topspin2, sfxpointt2, laserturret1, laserbarrel1, laserfirepoint11, laserfirepoint12, laserturret2, laserbarrel2, laserfirepoint21, laserfirepoint22})
