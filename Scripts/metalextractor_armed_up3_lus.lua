...
local function RestoreAfterDelay()
	...
	Turn(flameturret2, y_axis, 0, 5)
	Turn(flamebarrel2, x_axis, 0, 5)
end
...
function script.AimWeapon(WeaponID, heading, pitch)
	...
	elseif WeaponID == 2 then
		...
		Turn(flameturret2, y_axis, heading, 10)
		Turn(flamebarrel2, x_axis, -pitch, 10)
		WaitForTurn(flameturret2, y_axis)
		WaitForTurn(flamebarrel2, x_axis)
		StartThread(RestoreAfterDelay)
		return true
	elseif WeaponID == 3 then
		Signal(SIG_AIM3)
