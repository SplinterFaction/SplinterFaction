...
base, cannonturret1, cannonbarrel1, cannonfirepoint1, cannonturret2, cannonbarrel2, cannonfirepoint2, cannonturret3, cannonbarrel3, cannonfirepoint3,  cannonturret4, cannonbarrel4, cannonfirepoint4, missileturret1, missilebarrel1, missilefirepoint1, torpedofirepoint1 = piece('base', 'cannonturret1', 'cannonbarrel1', 'cannonfirepoint1', 'cannonturret2', 'cannonbarrel2', 'cannonfirepoint2', 'cannonturret3', 'cannonbarrel3', 'cannonfirepoint3',  'cannonturret4', 'cannonbarrel4', 'cannonfirepoint4', 'missileturret1', 'missilebarrel1', 'missilefirepoint1', 'torpedofirepoint1')
...
function script.Create()
	StartThread(common.SmokeUnit, {base, cannonturret1, cannonbarrel1, cannonfirepoint1, cannonturret2, cannonbarrel2, cannonfirepoint2, cannonturret3, cannonbarrel3, cannonfirepoint3,  cannonturret4, cannonbarrel4, cannonfirepoint4, missileturret1, missilebarrel1, missilefirepoint1, torpedofirepoint1})
end
