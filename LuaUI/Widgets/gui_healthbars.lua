...
do
	...
	function DrawUnitInfos(unitID, unitDefID)
		...
		if overshieldPower then
			--Spring.Echo("unitname: ".. unitDefs.name)
			--Spring.Echo("overshieldPower: " .. overshieldPower)
			local maxOvershieldPower = unitDefs.customParams.shield_max_strength
			--Spring.Echo("maxOvershieldPower: " .. maxOvershieldPower)
