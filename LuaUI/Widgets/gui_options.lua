...
function init()
	...
	options = {
		...
		--{id="grassdetail", group="gfx", name="Grass", type="slider", min=0, max=10, step=1, value=tonumber(Spring.GetConfigInt("GrassDetail",0) or 7), description='Amount of grass rendered\n\nChanges will be applied next game'},
