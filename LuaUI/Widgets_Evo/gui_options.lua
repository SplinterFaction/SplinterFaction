...
function init()
	...
	options = {
		...
		-- UI
		{id="buildordermenu", group="ui", name="Build Menu Preset", type="select", options={'Traditional Large','Traditional Small','Traditional Compact'}, value=Spring.GetConfigInt("evo_buildorderui",0) + 1, description='Use these presets to change the build menu size and position.\nBuild and Order menus can further be custom positioned using TweakMode (ctrl+f11)\n\nNOTE: Changing this setting will cause the interface to be reloaded'},
