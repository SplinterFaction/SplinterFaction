...
local TechToStr = {TechColour[1].."Tech 1", TechColour[2].."Tech 2", TechColour[3].."Tech 3", TechColour[4].."Tech 4"}
    ...
    elseif ud.weapons and ud.weapons[1] and ud.weapons[1].weaponDef then
		...
		for _,w in pairs(ud.weapons) do
		    ...
		    if weap.isShield == false and weap.description ~= "No Weapon" then
				...
				if damagetype == "light" or damagetype == "antilight" then damagetype = "Light" end
				...
				NewTooltip = NewTooltip.."\n\255\255\255\255"..weap.description.."    "..actionStr.."    AoE: "..AOE.."(r)     Range: "..FormatNbr(range,2)
