local root = "bar-genericbuildingexplosion"
local definitions = {
  [root.."-small"] = {
    centerflare = {
      air                = true,
...
definitions['bar-genericshellexplosion-meteor'] = table.copy(definitions[root.."-huge"])
definitions['bar-genericshellexplosion-meteor'].groundflash_large.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].groundflash_white.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].explosion.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].explosion.properties.particlespeed = 1.5
definitions['bar-genericshellexplosion-meteor'].explosion.properties.particlespeedspread = 11
definitions['bar-genericshellexplosion-meteor'].centerflare.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].sparks.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].innersmoke.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].outersmoke.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].dirt.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].dirt2.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].shard1 = nil
definitions['bar-genericshellexplosion-meteor'].shard2 = nil
definitions['bar-genericshellexplosion-meteor'].shard3 = nil
definitions['bar-genericshellexplosion-meteor'].grounddust.properties.alwaysvisible = true
definitions['bar-genericshellexplosion-meteor'].clouddust = nil
--definitions['bar-genericshellexplosion-meteor'].groundclouddust.properties.alwaysvisible = true
--definitions['bar-genericshellexplosion-meteor'].kickedupwater.properties.alwaysvisible = true
